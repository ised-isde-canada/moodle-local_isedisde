...
/**
 * Main login page.
 * Customized version by Michael Milette, TNG Consulting Inc.
 * Will redirect directly to identity provider is only one is defined
 * instead of the normal Moodle login page.
 *
 * @package    core
 * @subpackage auth
 * @copyright  2020 onwards TNG Consulting Inc. https://tngconsulting.ca
...
if (!empty($SESSION->loginerrormsg)) {
    ...
    redirect(new moodle_url('/local/isedisde/index.php'));
}
